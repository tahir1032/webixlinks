      ...
      <article>
        <div className="mx-auto w-full px-4 sm:px-6 lg:px-8 max-w-3xl py-12 md:py-16">
          ...
          <aside className="mt-16 rounded-xl border border-red-500/20 bg-gradient-to-br from-red-500/10 to-zinc-900/50 p-8">
            ...
            <h3 className="mt-3 text-xl font-semibold text-white">Ready to start your project?</h3>
            <p className="mt-2 text-sm leading-relaxed text-zinc-400">
              Send us a message and we&apos;ll come back within one business day with a clear plan and an
              honest quote.
            </p>
